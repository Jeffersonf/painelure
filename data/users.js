(function () {
  ...
  P.seedData.users = [
    ...
    mapUser({ id: "user-ctc", name: "Gustavo", login: "Gustavo", role: "Técnicos CTC", contactName: "Gustavo Miller", contactRole: "CTC", email: "itv.setec@educacao.sp.gov.br", active: true }),
    ...supervisorUsers
  ];
})();
