...
function run() {
  ...
  assertAccess(P, "Administrador", ["admin", "network", "inventory", "bi-equipment", "profiles", "satisfaction"], []);
  assertAccess(P, "Supervisao", ["dashboard", "schools", "network", "supervision"], ["satisfaction", "inventory", "bi-equipment", "cars", "reports", "admin"]);
  assertAccess(P, "Tecnicos CTC", ["network", "inventory", "ctc", "calls", "cars", "supervision", "calendar", "reports", "profiles", "quality"], ["satisfaction", "bi-equipment", "admin"]);
  assertAccess(P, "CTC", ["network", "inventory", "ctc", "calls", "cars", "supervision", "calendar", "reports", "profiles", "quality"], ["satisfaction", "bi-equipment", "admin"]);
  assertAccess(P, "SETEC", ["network", "inventory", "calendar"], ["satisfaction", "bi-equipment", "reports", "admin"]);
  assertAccess(P, "SEINTEC", ["network", "inventory", "ctc", "calls", "cars", "supervision", "calendar", "reports", "profiles", "quality"], ["satisfaction", "bi-equipment", "admin"]);
